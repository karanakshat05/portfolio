  ...
  return (
    <div id="Projects" className="p-10 md:p-24 text-white ">
      ...
      <div className="py-12 px-8 flex flex-wrap gap-5">
        <ProjectCard
          title="Wildlife Surveillance System"
          main="Developing an AI and IoT-powered drone system for real-time animal detection, event tagging, and monitoring to address human-animal conflicts and herd tracking."
        />
        <ProjectCard
          title="Youtue Clone"
